...
"""
class Classifier5ViT(nn.Module):
    def __init__(self):
        super().__init__()
        self.name = "Classifier_5_ViT"
...
class Classifier5ViTTrainer():
    def __init__(self, args, \
        ...
        self.model = Classifier5ViT()

        self.lossfn = LossFN()
        self.evaluater = Classifier5ViTEvaluater(self.data_loader_val, self.classifier_kinds)
